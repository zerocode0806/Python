...
class MazeGame:
    ...
    def setup_pygame_surface(self):
        ...
        try:
            ...
            text4 = font_small.render("Minimap has Fog of War!", True, (255, 200, 100))
    ...
    def handle_tkinter_key_event(self, event):
        ...
        # Only handle keys if pygame is focused and maze exists
        if not self.pygame_focused or not self.maze or self.show_solution or self.minimap_expanded:
    ...
    def render_expanded_minimap(self):
        ...
        # Draw maze on expanded minimap with fog of war
        for row in range(self.height):
            for col in range(self.width):
        ...
        instruction = font.render("Click X to close | ESC to close | Camera view in cyan | Fog of War active", True, (255, 255, 255))
